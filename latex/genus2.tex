...
\[ \includegraphics[scale=0.5,angle=90,clip=true,
                    trim=12cm 10cm 12cm 10cm]{../images/XX.jpg}
\]
...
as follows.
\input{tikz_includes/H_to_P_graph}
...
\begin{remark}\lbl{rem-curves-roothalf}
 ...
 \[ \includegraphics[scale=0.25,clip=true,
      trim=6cm 6cm 6cm 6cm]{../images/curves.jpg}
 \]
\end{remark}
...
\begin{center}
 \begin{tikzpicture}[scale=1.5]
  \begin{scope}
   \input{tikz_includes/y_proj_a}
   \draw (0,-1.7) node {$a=1/2$};
  \end{scope}
  \begin{scope}[xshift=3.5cm]
   \input{tikz_includes/y_proj_b}
   \draw (0,-1.7) node {$a=1/\rt$};
  \end{scope}
  \begin{scope}[xshift=7.0cm]
   \input{tikz_includes/y_proj_c}
...
\input{tikz_includes/w_proj_F16}
...
displayed as follows:
\input{tikz_includes/disc_delta}
...
corresponding monomials.  The full calculation cn be carried out using
